...
class MPU6050:
	...
	#not checked
	tempHigh=self.i2c.readBytes(self.MPU6050_RA_TEMP_OUT_H,1)
	tempLow=self.i2c.readBytes(self.MPU6050_RA_TEMP_OUT_L,1)
	if tempHigh[0] >=128:
		tempHigh[0]-=256
	temperature = tempHigh[0]*128+tempLow[0]
	print tempHigh[0],',',tempLow[0]
        return temperature
	...
	# Some of the Data are never used, why?
        if packet[0] > 127:
            packet[0] -= 256
